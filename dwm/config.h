...
static const char *dmenucmd[]   = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg_c, "-nf", col_fg_y, "-sb", col_fg_y, "-sf", col_bg_c, NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_w,      spawn,          {.v = fibrowser } },
